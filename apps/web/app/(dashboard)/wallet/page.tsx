...
export default function WalletPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      <h1 className="font-display text-3xl text-frost mb-6">Your wallet</h1>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-10">
        <div className="pixel-cut bg-void-deep p-6 flex flex-wrap gap-6">
          {wallet ? (
            ...
            <p className="text-frost/40">Loading…</p>
          )}
        </div>

        <div className="pixel-cut bg-panel border border-frost/10 p-6">
          <h2 className="font-display text-lg text-frost mb-3">Add credits</h2>
          ...
          >
            {amountValid
              ? `Top up ฿${effectiveAmount.toLocaleString('th-TH')} via PromptPay`
              : 'Enter an amount'}
          </button>
        </div>
      </div>

      <h2 className="font-display text-xl text-frost mb-4">Transaction history</h2>
      {transactions ? (
        <>
